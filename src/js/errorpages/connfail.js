...
(new function(window, document) {
  ...
  document.addEventListener('DOMContentLoaded', async () => {
    ...
    chrome.runtime.sendMessage({request: "RequestErrorInfo", id: queryStr.id}, async (response) => {
      if(!response)
        return
      ...
      window.onunload = () => chrome.runtime.sendMessage({request: "RequestErrorDelete", id: queryStr.id})
    })
  })
